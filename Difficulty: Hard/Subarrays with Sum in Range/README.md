<h2><a href="https://www.geeksforgeeks.org/problems/count-the-number-of-subarrays/1?_gl=1*ih1eci*_up*MQ..&gclid=Cj0KCQjwjvfSBhDpARIsAEiOpSuw9nEgL6i8HqJwFFo7Y1e580LOv1RT_e8Hqk468Mt3do0oD-qcDSUaAlgeEALw_wcB&gbraid=0AAAAAC9yBkBSRHAPS7eM3ObFN3tiryjWZ">Subarrays with Sum in Range</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an integer array <strong>arr[]</strong> and two integers <strong>l</strong> and <strong>r</strong>, find the number of subarrays whose sum lies in the range [l, r] (inclusive).</span></p>
